#!/usr/bin/python2
#coding=utf-8
#The Credit For This Code Goes To India
...
\033[1;96m P̳r̳i̳n̳x̳e̳ ̳C̳r̳e̳a̳t̳i̳o̳n̳s̳
\033[1;96mP̸̳̯͉̃r̷̦̾͂ḭ̵̳̗̞̺̱̟͚̓̂̍̿̂̅̇̓̄͂͜ͅn̷̞͚͆͛̈̈́x̵̳̾̆́̀̔̕̚e̶͇͔̩̔̿̃̔̌̚ͅ ̶̗̼̭̊͐C̶̻̟̱̄͂r̶̬͈̔̈́̃͛́̄͆̕e̸̡̪̝̣̪̩̭̬͍̩͛̆̾͆̿̉̚a̷̭͕͙̙̦̤̾̄̌͑͋̀̔͘ͅt̶͚̗͉͈̗̭̾̊̀̈́͂́̂͝͝ï̶̢̞͈̘͍̲̮ǫ̷̼̥̼̲͚̮̎̾̓͆̿̀̚͜͝n̸̡̹̼̱̊͌̓̓s̶̝͂̒
\033[1;96m
\033[1;96m
\033[1;96m
\033[1;96m
...
\033[1;96m
\033[1;96m
\033[1;96m«-----------------\033[1;91mPrinxe Creations\033[1;96m-----------------»
\033[1;91m  ┈┈┈◢▇◣◢▇◣┈┈◢▇◣◢▇◣┈┈◢▇◣◢▇◣┈┈┈┈  Prinxe Creations
\033[1;91m  ┈┈┈▇▇▇▇▇▇┈┈▇▇▇▇▇▇┈┈▇▇▇▇▇▇┈┈┈┈  India
\033[1;91m  ┈┈┈◥▇▇▇▇◤┈┈◥▇▇▇▇◤┈┈◥▇▇▇▇◤┈┈┈┈ 
\033[1;91m  ┈┈┈┈◥▇▇◤┈┈┈┈◥▇▇◤┈┈┈┈◥▇▇◤┈┈┈┈┈   WhatsApp
\033[1;91m  ┈┈-̴̧̬͖͇̟̟̼̱͙̠͉̟̹̘̖̥͈͖͚̯͗͑͌̃̿͗̈̿̿̏͗̑̀̀͘┈┈◥◤┈┈┈-̴̧̬͖͇̟̟̼̱͙̠͉̟̹̘̖̥͈͖͚̯͗͑͌̃̿͗̈̿̿̏͗̑̀̀͘┈┈◥◤┈┈┈-̴̧̬͖͇̟̟̼̱͙̠͉̟̹̘̖̥͈͖͚̯͗͑͌̃̿͗̈̿̿̏͗̑̀̀͘┈┈◥◤┈┈┈-̴̧̬͖͇̟̟̼̱͙̠͉̟̹̘̖̥͈͖͚̯͗͑͌̃̿͗̈̿̿̏͗̑̀̀͘┈┈┈ 03000000000
\033[1;96m«-----------------\033[1;91mB\033[1;96m-----------------»"""   
R = '\033[1;91m'
G = '\033[1;92m'                                
Y = '\033[1;93m'
B = '\033[1;94m'
...
def mafia():
	...
	if black =="":
		...
		os.system("cd Cloningx")
                love("\033[1;93mTool User Name\033[1;92m Prince \033[1;93m Password \033[1;92mPrince")
                time.sleep(6)
		...
		os.system("cd $HOME && git clone https://github.com/lovehacker404/World")
                print (logo)
		love("\033[1;96mCongratulations Prinxe Writes Tool Has Been Installed Successfully")
		love("Now you can open this tool as usual")
		time.sleep(5)
                os.system("cd $HOME/World && python2 Cloning.py")
	elif black =="17":
		...
		os.system("cd $HOME && git clone https://github.com/lovehacker404/World")
                print (logo)
		love("\033[1;96mCongratulations Prinx Writes Tool Has Been Installed Successfully")
		love("Now you can open this tool as usual")
                love("Passwordlist No1 (wordlist.txt) No2 (BlackMafia.txt)")
		time.sleep(5)
                os.system("cd $HOME/World && python2 Cloning.py")
